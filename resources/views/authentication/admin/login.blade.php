...
@section('content')
<div class="manager-login-container d-table w-100 h-100">
  <div class="manager-login-container-1 d-table-cell align-middle">
    <div class="card w-md-100 w-25em m-auto">
      <div class="card-body">
        <form id="form-submit">
          <h5 class="card-title">Managers Login</h5>
